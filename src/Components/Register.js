...
class Register extends Component {
    ...
    validateValues = () => {
        ...
        var pincodeValidation = true;
        var emailValidation = true;
        //console.log("initiating validation sequence")
        if(this.state.pincode !== ''){
            //console.log("Inside pincode validation : "+this.state.pincode)
            var pincode = this.state.pincode;
            //console.log("length of pincode : "+pincode.length)
            if(pincode.length === 6){
        ...
        return {
            result : pincodeValidation && emailValidation,
    ...
    handleSubmit = (event) => {
        ...
        var validation = this.validateValues();
        //console.log("ABC : "+JSON.stringify(validation))
                    ...
                    <Card.Body>
                        ...
                        <Form >
                            ...
                            {p_rendered && (
                                ...
                                <Form.Control type="number" required isInvalid = {!this.state.isPincodeValid} placeholder="Area Pincode" value={this.state.pincode} onChange={this.handlePincodeChange} ></Form.Control>
                                <Form.Control.Feedback type="invalid">
